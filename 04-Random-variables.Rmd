...
In a previous chapter, we developed a general framework for modeling
...
5.  Identify standard properties of the PDF and CDF.
6.  Calculate the expected value of a discrete random variable from its PDF.
7.  Calculate quantiles of a random variable from its CDF.
8.  Calculate the variance and standard deviation of a discrete random variable
    from its PDF.
9.  Calculate the variance and standard deviation using the expected
    value formula.
...
12. Work with standard discrete probability distributions including the 
