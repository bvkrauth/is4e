...
discrete.  Chapter ?? will cover continuous random variables. 
...
## The properties of a random variable {#the-properties-of-a-random-variable}
...
### Medians, quantiles and percentiles {#medians-quantiles-and-percentiles}
...
This simple definition works fine in some cases but not
...
The median is often interpreted as measures of a random variable's
"central tendency", or as a prediction of its "typical" value. The expected 
