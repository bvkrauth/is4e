...
as well as pairs or groups of related random variables.  We will then
apply the concept of a random variable to
[statistics](#statistics) calculated from data.
