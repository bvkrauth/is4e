...
The math used in this textbook is all covered in high school or in 
introductory calculus. However, you may have forgotten it, or never 
understood it very well in the first place.  This appendix provides
a review of the most important mathematical terms, concepts and 
methods.  It can be used to review ideas before starting the main
...
3. Calculate the cardinatity of the sets you defined in problems (1) and (2) above.
...
### Practice problem answers {#answers-math-review}
