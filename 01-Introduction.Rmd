...
many other good jobs where at least data analysis skills are a big asset.
So you should take this course as a lucrative investment opportunity, and not
just a requirement for the economics major.
...
Mona Lisa) your labour will sell at a low price.  If your skills are common
and useless (like garbage), your labour may not sell at any price.

|             |          High demand                       |                 Low demand                    |
|-------------|:------------------------------------------:|:---------------------------------------------:|
| Low supply  | <img src="bin/MonaLisa.png" width="100" /> | <img src="bin/BadMonaLisa.png" width="100" /> |
| High supply | <img src="bin/Water.png" width="1   00" />    | <img src="bin/Garbage.png" width="200" />     |
