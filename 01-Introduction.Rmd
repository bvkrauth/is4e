...
In ECON 333, you will learn more advanced techniques including 
...
- Chapters:
  - Each chapter corresponds to roughly a week of the course.
- Typography:
  - Computer code or other inputs are shown `like this`.
  - When new terminology is introduced, it is shown ***like this***.
- Boxes:
  - Pull-out information is shown in a variety of boxes.
