...
Its support is the range of all values from 2 to 5, and its PDF is depicted in
Figure \@ref(fig:UniformPDF) below. 
:::
...
Figure \@ref(fig:UniformCDF) shows the CDF of the $U(2,5)$ distribution.
:::
