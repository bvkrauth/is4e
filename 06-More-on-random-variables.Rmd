...
variables: PDFs, CDFs, and expected values. You should work hard and do
as many practice problems as you can, as a clear understanding of random
variables will make the rest of the course much easier to follow.
...
17. Find the following variances and covariances,, where $y$ is an
   indicator for winning a "Yo" bet in craps, and $b$ is an indicator for
   winning a "Boxcars" bet.
    a. Find $cov(16y,31b)$
    b. Find $var(y + b)$
