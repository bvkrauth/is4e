...
6. Let $f_{y,b}(\cdot)$ be the joint PDF of $y$ and $b$.
   a. Find $f_{y,b}(1,1)$
   b. Find $f_{y,b}(0,1)$
   c. Find $f_{y,b}(1,0)$
   d. Find $f_{y,b}(0,0)$
...
7.  Let $f_b(\cdot)$ be the marginal PDF of $b$.
...
8. Let $f_{y|b}(1,1)$ be the conditional PDF of $y$ given $b$.
   a. Find $f_{y|b}(1,1)$.
   b. Find $f_{y|b}(0,1)$.
   c. Find $f_{y|b}(1,0)$.
   d. Find $f_{y|b}(0,0)$.
...
10. Which of the following pairs of random variables are independent?
    a. $y$ and $t$
    b. $y$ and $b$
    c. $r$ and $w$
    d. $r$ and $y$
...
11. Find $cov(y,b)$ using the joint PDF $f_{y,b}(\cdot)$.

**GOAL #12: Calculate the covariance of two random variables using the expected value formula**

12. Find the following covariances using the alternate formula:
...
13. Find $corr(y,b)$ using the results you found earlier.
...
15. We earlier found that $r$ and $w$ were independent. Using this information:
    a. Find $cov(r,w)$.
    b. Find $corr(r,w)$.

**GOAL #15: Calculate the expected value of a linear function of two or more random variables**

16. Your net winnings if you bet \$1 on Yo and \$1 on Boxcars can
    be written $16y + 31b - 2$. Find the following expected values:
    a. Find $E(y + b)$
    b. Find $E(16y + 31b - 2)$

17. Find the following variances and covariances:
    a. Find $cov(16y,31b)$
    b. Find $var(y + b)$
