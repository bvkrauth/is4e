...
Importing and exporting across different formats is a little like translating
between languages: information can get lost or misinterpreted, so it
...
to open formats just to be nice; their incentives changed as a result of 
technological advances, and they responded by changing their behavior.
...
There is also a function called `HLOOKUP()` for use when you have a table with
