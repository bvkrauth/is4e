...
In an earlier chapter, we learned some basic data
[cleaning](#basic-data-cleaning-with-excel) and
[analysis](#basic-data-analysis-with-excel)
skills using Excel.  This chapter will build on these skills by teaching some
more advanced tools and concepts. We will do this while building a data set
describing long-run economic growth in a wide cross-section of countries.
...
As always, be sure to save your work and update/create the master version of
