...
## More on data file formats {#more-on-data-file-formats}
...
You often see fixed-width files in large data sets like major surveys, and they
often come with a "dictionary" file that describes where each column begins
and ends.
...
- ***Tab-delimited*** text files use a tab character as the delimiter.
...
Save this file as `TaxRates_WC.xlsx` and exit Excel.
:::
