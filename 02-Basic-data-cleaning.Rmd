...
3. Use basic Excel terminology and concepts including:
   ...
   - Cell ranges
4. Use Excel tools to view data, including:
   - Sorting
   - Filtering
   - Freezing panes
   - Changing cell size
5. Use fill and series to enter new data.
6. Use Excel formulas to construct new variables.
7. Use relative and absolute cell addresses in Excel formulas.
8. Use logical and text data in Excel.
9. Use dates in Excel.
:::
