...
Most of the time our new variables will be calculated from existing variables.
...
#### A simple formula {#a-simple-formula}
...
#### Copying, pasting and relative references {#copying-pasting-and-relative-references}
...
1. Enter **LogPop*8 in cell K1 to give the variable a name.
2. Select cell K2.
...
#### Combining absolute and relative references {#combining-relative-and-absolute-references}
...
## Using non-numeric data {#using-non-numeric-data}
...
The **Province** column contains ***text data***, also called
