...
Each chapter includes a few simple practice problems to help you check
your knowledge.  They are organized by the specific skill or knowledge base
you are practicing.
...
4. Which tool (fill, series, insert, or copy/paste) would you use for each of
   ...
   c. Fill a cell range with a sequence of ascending even numbers (e.g., 2, 4, 6).
...
7. Construct an Excel formula to do each of the following.
   a. Display "Reject" if cell A2 contains a number less than 0.05,
      and display "Fail t reject" otherwise.
