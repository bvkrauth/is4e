...
- Produce simple but informative histograms and line graphs using ggplot.
:::
...
3. Using the `PPData`data set, construct a freqency table of the employment rate.
...
### Practice problem answers {#answers-using-r}
