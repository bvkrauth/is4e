...
All three of these random variables have  ***discrete*** 
support. That is, the support is a set of isolated points 
each of which has a strictly positive probability.

Not all random variables are discrete: for example, physical conditions
such as temperature or mass are fundamentally continuous. If 
you buy a 5kg bag of flour at the grocery store
it almost certainly won't contain exactly 5kg of flour; 
it may contain 4.98 kg or 5.01 kg, or any number in between.
This complicates matters substantially because there are an infinite
number of possible values, and this infinite number of probabilities
somehow needs to sum to one.  We will need some calculus to
deal with this case, but first let's explore the discrete case.
