...
Then download the following four data files:
...
5. Construct the appropriate formula in cell A2:
...
3. Enter the correct formula in cell K2:
...
N, and calculated data in the other columns.  To prevent changes to the raw
data but not the calculated data, we will need the worksheet to be *protected*,
columns A through N to be *locked*, and all other columns to be *unlocked*.
...
4. Lock columns A through N by selecting them, and then selecting 
...
5. The following tables are based on 2019 data for Canadians aged 25-34.
