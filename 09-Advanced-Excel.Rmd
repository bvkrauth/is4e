...
The most important general file format is the ***text file***. A text file
contains a sequence of characters (letters, numbers, etc.). Almost all open
file formats are built around text files.
