...
- [https://bkrauth-is4e.share.connect.posit.cloud/sampledata/pwt100.xlsx](sampledata/pwt100.xlsx)
- [https://bkrauth-is4e.share.connect.posit.cloud/sampledata/TaxRates.xlsx](sampledata/TaxRates.xlsx)
- [https://bkrauth-is4e.share.connect.posit.cloud/sampledata/EmploymentData.xlsx](sampledata/EmploymentData.xlsx).
- [https://bkrauth-is4e.share.connect.posit.cloud/sampledata/CountryCodes.txt](sampledata/CountryCodes.txt)  
...
The current version of the PWT is available at https://www.rug.nl/ggdc/productivity/pwt/?lang=en
...
Many of them are free:
  ...
  - Microsoft's *VSCode* is popular with programmers, and is available at no
    charge from https://code.visualstudio.com/.
    VSCode is available for Windows,
...
[https://bkrauth-is4e.share.connect.posit.cloud/sampledata/CanEmpNov20.csv](sampledata/CanEmpNov20.csv).
...
[https://bkrauth-is4e.share.connect.posit.cloud/sampledata/GrowthData.xlsx](sampledata/GrowthData.xlsx)
:::
...
in this chapter at
[https://bkrauth-is4e.share.connect.posit.cloud/sampledata/EmploymentDataPT.xlsx](sampledata/EmploymentDataPT.xlsx) 
