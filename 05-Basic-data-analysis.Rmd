...
[https://bkrauth-is4e.share.connect.posit.cloud/sampledata/CanEmpHist.xlsx](sampledata/CanEmpHist.xlsx) and put it in your raw data subfolder.
...
Next, we will calculate some commonly-used ***univariate*** statistics, 
...
4. **Closeness**: Minimize eye movement by keeping related information visually
   "close."
5. **Reinforcement**: Use color and formatting to reinforce interpretation
...
5. **Accessibility**: Take reader needs into account.  For example:
   - Color is not always available to readers: Some readers are color
     ...
     - Consider using a color palette that is colorblind-friendly.
       - A simple way to do this is to avoid using red and green as contrasting
         colors, since this is the most common form of colorblindness
         (blue/yellow colorblindness is also common).
...
You can download
[https://bkrauth-is4e.share.connect.posit.cloud/sampledata/CanEmpHistResults.xlsx](sampledata/CanEmpHistResults.xlsx) if you want to check your work against mine. 
:::
