...
In a previous chapter, we learned how to 
[clean a simple data set](#basic-data-cleaning-with-excel). The next step
is to learn how to analyze it. In this chapter, we will use Excel to
construct ***univariate*** statistics and charts, i.e., statistics and charts
that describe a single variable.
...
1. Use Excel tools for viewing larger data tables, including:
   ...
   - Filtering
   - Freezing panes
2. Calculate and interpret the main univariate summary statistics by hand:
   - Sample size (count)
   - Sample average
   - Sample percentiles and median
   - Sample variance and standard deviation
3. Calculate the main univariate summary statistics in Excel.
...
[https://bookdown.org/bkrauth/BOOK/sampledata/CanEmpHist.xlsx](sampledata/CanEmpHist.xlsx).
2. Make a working copy.
   - I called mine  `CanEmpHist_WC.xlsx`.
3. Open your working copy. It will look something like this:
...
Our historical employment data set covers over 500 months. Other data
