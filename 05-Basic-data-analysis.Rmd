...
and will be covered in Chapters \@ref(advanced-topics-in-statistics) and
\@ref(advanced-data-analysis).
...
Chapter \@ref(using-r-and-ggplot).
...
1. Double-click on the horizontal axis.  The `Format Axis` box
   ...
   - It may take you more than one try to double-click on the 
     correct object.
2. Select the button (***INSERT PICTURE HERE***) marked 
   "Axis Options".
