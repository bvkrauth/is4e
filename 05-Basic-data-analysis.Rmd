...
1. Calculate and interpret the main univariate summary statistics by hand:
   - Sample size (count)
   - Sample average
   - Sample percentiles and median
   - Sample variance and standard deviation
2. Calculate the main univariate summary statistics in Excel.
3. Construct and interpret simple and binned frequency tables in Excel
4. Construct and interpret time series (line) graphs in Excel
5. Construct and interpret bar graphs and histograms in Excel
:::
...
As humans, our brains are not large enough to fully understand a large data set
