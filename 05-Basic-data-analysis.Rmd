...
4. We now have a nice table of summary statistics:
   ...
   audience. Feel free to play around with colors, fonts, etc. to improve
   upon this table.
...
***frequency table***.  A frequency table describes how often 
each value appears in the data.
