...
Most high schools teach a little probability, but we will go deeper than you
have before. To do this, we will use mathematical notation and
terminology that you have seen before but may need to review.  If you have
difficulty with the math, please refer to the sections on [Sets](#sets) and [Functions](#sets) in the [Math Review](#math-review) appendix.
...
by law to operate fair roulette wheels and would be subject to heavy
penalties if they operate unfair wheels. Later on, we will use data
and statistics to evaluate whether a roulette wheel is *actually* fair.

Again each outcome in a fair roulette wheel has the same probability. Call
that probability $p$:
...
has equal chance of having a winning hand. But that is no longer true after you
see your cards - having "good" cards increases your chance of winning, and
having "bad" cards decreases that chance. You get to see your cards, so
your bet should be based on $\Pr(win|YourCards)$ rather than $\Pr(win)$. Good
