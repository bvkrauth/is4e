...
![roulette wheel image](bin/roulette.svg)
...
Since we want a condtional probability, we start by stating Bayes' law:
...
studies by well-known researchers[^2] dramatically overestimated the early
...
[^2]: If you are interested in learning more about this, an 
...
provides a thourough discussion 
