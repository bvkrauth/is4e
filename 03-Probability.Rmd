...
1. Given the definition above for the outcome of a single roll in craps: 
   a. Define its sample space by enumeration.
   b. Find the cardinality of this sample space.
...
7. Calculate each of the following elementary event probabilities:
   ...
   b. $(r,w) = (3,4)$
   c. $(r,w) = (6,6)$
8. Calculate the probability of each of the following events:
   a. A bet on Yo wins.
...
9. Calculate each of the following joint probabilities:
   a. $Pr(\textrm{Yo wins} \cap \textrm{Field wins})$
   a. $Pr(\textrm{Yo wins} \cap \textrm{Boxcars wins})$
   a. $Pr(\textrm{Yo wins} \cap \textrm{Boxcars loses})$
10. Calculate each of the following conditional probabilities:
    a. $Pr(\textrm{Yo wins} | \textrm{Field wins})$
    a. $Pr(\textrm{Yo wins} | \textrm{Boxcars wins})$
    a. $Pr(\textrm{Yo wins} \cap \textrm{Boxcars loses})$
    a. $Pr(\textrm{Field wins} | \textrm{Yo wins})$
    a. $Pr(\textrm{Boxcars wins} | \textrm{Yo wins})$
