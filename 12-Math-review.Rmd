...
The set $\{Avocado\}$ is a singleton.
:::
...
\begin{align}
  s(x) &= \begin{cases}
    ...
    \end{cases}
\end{align}
This way of expressing a function's values is called ***case notation***.
...
\end{align}
Sequences have cardinality (size or length):
\begin{align}
  () \textrm{ is an empty sequence.} \\
  (2,4,6) \textrm{ is a finite sequence of length 3.} \\
