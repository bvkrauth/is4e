...
2.  Use R expressions and vectors.
...
of code by clicking in is upper right-hand corner.  You can then paste it in
the console window.
:::
...
- As you type your command in, you may notice that RStudio shows various
  pop-ups with helpful information about the command.
...
We are done for now, so close RStudio.

You may get a warning message that looks something like this:
