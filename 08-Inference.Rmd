...
values. The main task of a person working with data is implementing the test.
Here are the steps:
...
In order for a hypothesis test to work, the exact probability distribution of
the test statistic must be known under the null hypothesis.  The example test in
the previous section worked because it was based on a sample frequency, a
statistic whose probability distribution is relatively easy to calculate.
