...
that the central limit theorem applies more broadly, and most commonly-used
statistics are also asymptotically normal.
...
This version of Slutsky's theorem can be used to extend the central limit
